<?php
	  	    session_start();$con=mysqli_connect("localhost","root","saurabh");
	  	    if(!$con)
	  {
	  				  ...
	  				  if(!$db)
	  {
	      ...
	      $query="select * from admin where email='$_POST[email]' AND password='$_POST[password]'";$query_run=mysqli_query($con,$query);
